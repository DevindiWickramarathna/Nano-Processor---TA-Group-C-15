...
S <= Y when Enable = '1' else (others => '0');
Overflow <= ( (A(3) XNOR (Operation XOR B(3))) AND (A(3) XOR Y(3)) ) when Enable = '1' else '0';
Zero <= ( NOT(Y(0) OR Y(1) OR Y(2) OR Y(3)) ) when Enable = '1' else '0';
